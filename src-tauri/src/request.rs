use reqwest::{Error, Client, header::HeaderMap, header::COOKIE, Proxy };
use serde::Serialize;
...
pub async fn fetch_data_buffer(url: &str, buffer: Vec<u8>, file_name: &str) -> Result<Vec<u8>, String> {
    ...
    body.extend_from_slice(format!("Content-Disposition: form-data; name=\"data\"; filename=\"{}\"\r\n\r\n", file_name).as_bytes());
